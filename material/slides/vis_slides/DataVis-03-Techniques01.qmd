...
<!-- <div>
  <iframe src="p_plot.pdf" width="100%" height="100%" style="border:0;">
    This browser does not support iframes — open the PDF: <a href="p_plot.pdf" target="_blank">p_plot.pdf</a>
  </iframe>
</div> -->
